...
do
    ...
    function pages:PlayerList(info)
        ...
        for Index = 1, 1 do
            ...
            --
            utility:LoadImage(button_gradient, "gradient", "https://i.imgur.com/9nNZFzi.png")
            --
            library.began[#library.began + 1] = function(Input)
        ...
        --
        utility:LoadImage(list_gradient, "gradient", "https://i.imgur.com/9nNZFzi.png")
        --
    ...
    function sections:Toggle(info)
        ...
        --
        utility:LoadImage(toggle__gradient, "gradient", "https://i.imgur.com/9nNZFzi.png")
        --
        function toggle:Get()
        ...
        function toggle:Colorpicker(info)
            ...
            utility:LoadImage(colorpicker__gradient, "gradient", "https://i.imgur.com/9nNZFzi.png")
            --
        ...
        function toggle:Keybind(info)
            ...
            --
            utility:LoadImage(keybind__gradient, "gradient", "https://i.imgur.com/9nNZFzi.png")
            --
    ...
    function sections:Slider(info)
        ...
        --
        utility:LoadImage(slider__gradient, "gradient", "https://i.imgur.com/9nNZFzi.png")
        --
    ...
    function sections:Button(info)
        ...
        library.began[#library.began + 1] = function(Input)
            if Input.UserInputType == Enum.UserInputType.MouseButton1 and button_outline.Visible and window.isVisible and utility:MouseOverDrawing({section.section_frame.Position.X, section.section_frame.Position.Y + button.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + button.axis + 20}) and not window:IsOverContent() then
                task.spawn(function()
                    utility:LoadImage(button_gradient, "gradientdown", "https://i.imgur.com/9nNZFzi.png") 
                    --
                    task.wait(0.15)
                    --
                    utility:LoadImage(button_gradient, "gradient", "https://i.imgur.com/9nNZFzi.png") 
    ...
    function sections:TextBox(info)
        ...
        --
        utility:LoadImage(textbox_gradient, "gradient", "https://i.imgur.com/9nNZFzi.png")
        --
    ...
    function sections:Dropdown(info)
        ...
        utility:LoadImage(dropdown__gradient, "gradient", "https://i.imgur.com/9nNZFzi.png")
        --
        if max then
    ...
    function sections:Multibox(info)
        ...
        utility:LoadImage(multibox__gradient, "gradient", "https://i.imgur.com/9nNZFzi.png")
        --
                ...
                elseif utility:MouseOverDrawing({section.section_frame.Position.X, section.section_frame.Position.Y + multibox.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + multibox.axis + (name and 15 or 0) + 20}) and not window:IsOverContent() then
                    ...
                    if not multibox.open then
                        ...
                        for i,v in pairs(multibox.options) do
                            ...
                            --
                            utility:LoadImage(multibox_value_gradient, "gradient", "https://i.imgur.com/9nNZFzi.png")]]
                            --
...
function utility:UpdatePreview(Pass)
    if (Silentware.Locals.Window and Silentware.Locals.Window.isVisible and Silentware.Locals.SelectedPage == "Players") or Pass then
        if Silentware.Locals.SelectedPage and Silentware.Locals.SelectedPlayersSection then
            local Size = {0, 0}
            local Selection = ("Players" .. Silentware.Locals.SelectedPlayersSection .. "_")
            --
            if Flags[Selection .. "Chams"]:Get() then
                ...
                --
                local ChamsAuto = Silentware.Locals.SelectedPlayersSection ~= "Local" and Flags[Selection .. "ChamsAuto"]:Get()
                ...
                --
                Silentware.Locals.Window.VisualPreview:SetComponentProperty("Chams", "Color", ChamsOutline, 1)
                Silentware.Locals.Window.VisualPreview:SetComponentProperty("Chams", "Transparency", 1 - ChamsOutlineTransparency, 1)
                Silentware.Locals.Window.VisualPreview:SetComponentProperty("Chams", "Color", ChamsAuto and ((Silentware.Locals.Window.VisualPreview.Visible) and ChamsVisible or ChamsHidden) or ChamsFill, 2)
                Silentware.Locals.Window.VisualPreview:SetComponentProperty("Chams", "Transparency", 1 - (ChamsAuto and ((Silentware.Locals.Window.VisualPreview.Visible) and ChamsVisibleTransparency or ChamsHiddenTransparency) or ChamsFillTransparency), 2)
            else
                Silentware.Locals.Window.VisualPreview:SetComponentProperty("Chams", "Transparency", 0, 1)
                Silentware.Locals.Window.VisualPreview:SetComponentProperty("Chams", "Transparency", 0, 2)
            end
            --
            if Flags[Selection .. "Box"]:Get() then
                ...
                --
                Silentware.Locals.Window.VisualPreview:SetComponentSelfProperty("Box", "Box", "Color", BoxColor)
                Silentware.Locals.Window.VisualPreview:SetComponentSelfProperty("Box", "Box", "Transparency", 1 - BoxTransparency)
                Silentware.Locals.Window.VisualPreview:SetComponentSelfProperty("Box", "Outline", "Transparency", 1 - BoxTransparency)
                Silentware.Locals.Window.VisualPreview:SetComponentSelfProperty("Box", "Fill", "Color", BoxFillColor)
                Silentware.Locals.Window.VisualPreview:SetComponentSelfProperty("Box", "Fill", "Transparency", 1 - BoxFillTransparency)
            else
                Silentware.Locals.Window.VisualPreview:SetComponentProperty("Box", "Transparency", 0)
            end
            --
            ...
            if Flags[Selection .. "HealthBar"]:Get() then
                Silentware.Locals.Window.VisualPreview:SetComponentSelfProperty("HealthBar", "Box", "Transparency", 1 - HealthBarTransparency)
                Silentware.Locals.Window.VisualPreview:SetComponentSelfProperty("HealthBar", "Outline", "Transparency", 1 - HealthBarTransparency)
                --
                Size[1] = 5
            else
                Silentware.Locals.Window.VisualPreview:SetComponentProperty("HealthBar", "Transparency", 0)
            end
            --
            if Flags[Selection .. "HealthNum"]:Get() or Flags[Selection .. "HealthBar"]:Get() then
                Silentware.Locals.Window.VisualPreview.Color1 = HealthBarColor
                Silentware.Locals.Window.VisualPreview.Color2 = HealthBarColor2
                --
                Silentware.Locals.Window.VisualPreview:UpdateHealthBar()
            end
            --
            if Flags[Selection .. "HealthNum"]:Get() then
                Silentware.Locals.Window.VisualPreview:SetComponentSelfProperty("HealthBar", "Value", "Transparency", 1 - HealthBarTransparency or 0)
                --
                Silentware.Locals.Window.VisualPreview:UpdateHealthValue(Size[1])
            else
                Silentware.Locals.Window.VisualPreview:SetComponentSelfProperty("HealthBar", "Value", "Transparency", 0)
            end
            --
            if Flags[Selection .. "Name"]:Get() then
                ...
                --
                Silentware.Locals.Window.VisualPreview:SetComponentSelfProperty("Title", "Text", "Color", NameColor)
                Silentware.Locals.Window.VisualPreview:SetComponentSelfProperty("Title", "Text", "Transparency", 1 - NameTransparency)
            else
                Silentware.Locals.Window.VisualPreview:SetComponentProperty("Title", "Transparency", 0)
            end
            --
            if Flags[Selection .. "Distance"]:Get() then
                ...
                --
                Silentware.Locals.Window.VisualPreview:SetComponentSelfProperty("Distance", "Text", "Color", DistanceColor)
                Silentware.Locals.Window.VisualPreview:SetComponentSelfProperty("Distance", "Text", "Transparency", 1 - DistanceTransparency)
            else
                Silentware.Locals.Window.VisualPreview:SetComponentProperty("Distance", "Transparency", 0)
            end
            --
            if Flags[Selection .. "Tool"]:Get() then
                ...
                --
                Silentware.Locals.Window.VisualPreview:SetComponentSelfProperty("Tool", "Text", "Color", ToolColor)
                Silentware.Locals.Window.VisualPreview:SetComponentSelfProperty("Tool", "Text", "Transparency", 1 - ToolTransparency)
            else
                Silentware.Locals.Window.VisualPreview:SetComponentProperty("Tool", "Transparency", 0)
            end
            --
            if Flags[Selection .. "Flags"]:Get() then
                ...
                --
                Silentware.Locals.Window.VisualPreview:SetComponentSelfProperty("Flags", "Text", "Color", FlagsColor)
                Silentware.Locals.Window.VisualPreview:SetComponentSelfProperty("Flags", "Text", "Transparency", 1 - FlagsTransparency)
            else
                Silentware.Locals.Window.VisualPreview:SetComponentProperty("Flags", "Transparency", 0)
            end
            --
            Silentware.Locals.Window.VisualPreview:ValidateSize("X", Size[1])
        end
    end
end
--
utility:Connection(rs.Heartbeat, function()
    local Tick = tick()
    --
    if (Tick - Silentware.Locals.LastPreviewUpdate) > 0.05 then
        utility:ThreadFunction(utility.UpdatePreview)
        Silentware.Locals.LastPreviewUpdate = Tick
    end
end)
--

-- init configs
if isfolder("Silentware/Configs") then
    for i,v in pairs(listfiles("Silentware/Configs")) do
        table.insert(Silentware.Configs, v:split("\\")[2]:split(".")[1])
    end
else
    makefolder("Silentware/Configs")
end
...
--
Silentware.Locals.ShiftTick = tick()
Silentware.Locals.Shift = 0
--
function Silentware:CheckTeam(Player1, Player2)
...
--
function Silentware:GetHealth(Player, Character, Humanoid)
    if Humanoid then
        return Clamp(Humanoid.Health, 0, Humanoid.MaxHealth), Humanoid.MaxHealth
    end
end
function Silentware:GetBodyParts(Character, RootPart, Indexes, Hitboxes)
    local Parts = {}
...
--
function Silentware:ValidateClient(Player)
...
do -- utility
    ...
    function Library:RefreshConfigList()
        Flags["ConfigConfiguration_Box"].options = Silentware.Configs
        Flags["ConfigConfiguration_Box"]:Refresh()
        Flags["ConfigConfiguration_Box"].current = Clamp(Flags["ConfigConfiguration_Box"].current, 0, #Silentware.Configs)
    end
    --
    ...
    function Library:PerformConfigAction(ConfigName, Action)
        ...
        if ConfigName then
            if Action == "Delete" then
                local Found = Find(Silentware.Configs, ConfigName)
                --
                if Found then
                    delfile(("Silentware/Configs/%s"):format(ConfigName .. ".Silentware"), Config)
                    Remove(Silentware.Configs, Found) 
            ...
            elseif Action == "Save" then
                ...
                if Config then
                    ...
                    if not Find(Silentware.Configs, ConfigName) then
                        print("Config not found")
                        writefile(("Silentware/Configs/%s"):format(ConfigName .. ".Silentware"), Config)
                        table.insert(Silentware.Configs, ConfigName)
                        Library:RefreshConfigList()
                    end
                    --
                    writefile(("Silentware/Configs/%s"):format(ConfigName .. ".Silentware"), Config)
            ...
            elseif Action == "Load" then
                local Config = readfile(("Silentware/Configs/%s"):format(ConfigName .. ".Silentware"))
                local Table = Split(Config, "\n")
                local Table2 = {}
                --
                if Table[#Table] == "[ Silentware ]" then
                    Remove(Table, #Table)
                end
                --
                for Index, Value in pairs(Table) do
    ...
    function Library:UpdateHue()
        if (tick() - Silentware.Locals.ShiftTick) >= (1 / 60) then
            Silentware.Locals.Shift = Silentware.Locals.Shift + 0.01
            --
            ...
            elseif Flags["ConfigTheme_AccentEffect"]:Get() == "Shift" then
                ...
                --
                Library:UpdateColor("Accent", Color3.fromHSV(Math:Shift(Hue + (Math:Shift(Silentware.Locals.Shift) * (Flags["ConfigTheme_EffectLength"]:Get() / 360))), Saturation, Value))
            elseif Flags["ConfigTheme_AccentEffect"]:Get() == "Reverse Shift" then
                local Hue, Saturation, Value = Flags["ConfigTheme_Accent"]:Get():ToHSV()
                --
                Library:UpdateColor("Accent", Color3.fromHSV(Math:Shift(Clamp(Hue - (Math:Shift(Silentware.Locals.Shift) * (Flags["ConfigTheme_EffectLength"]:Get() / 360)), 0, 9999)), Saturation, Value))
            end
            --
            Silentware.Locals.ShiftTick = tick()
        end
    ...
    function utility:ThreadFunction(Func, Name, ...)
        local Func = Name and function()
            ...
            --
            if not Passed and not Silentware.Safe then
                warn("Silentware:\n", "              " .. Name .. ":", Statement)
            end
        end or Func
    ...
    function utility:SafeCheck(Text)
        ...
        --
        for Index, Value in pairs(Silentware.Locals.BadWords) do Safe = Safe:gsub(Value, "_") end
        --
        return Safe
    end
    --
    ...
    function utility:MousePosition(Offset)
        if Offset then
            return UserInputService:GetMouseLocation() + Silentware:CursorOffset()
        else
