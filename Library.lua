    ...
    function  LOVE_LOVIN1111:Window()
        ...
        function  LOVE_LOVIN111111111111111111111:Tab(Title)
            ...
            function Tab:Section(Title, Side)
                ...
                function  LOVE_LOVIN1111111111111111111111111111111111111111111111111111111111111111111:Toggle(Options)
                    ...
                    local  LOVE_LOVIN1111111111111111111111111111111111111111111111111111111111111111111111111Hitbox = AddDrawing("Square", {
                        ...
                        Position = Vector2.new( LOVE_LOVIN1111111111111111111111111111111111111111111111111111111111111111111Inline.Position.X,  LOVE_LOVIN1111111111111111111111111111111111111111111111111111111111111111111Inline.Position.Y + 30 +  LOVE_LOVIN1111111111111111111111111111111111111111111111111111111111111111111111111.Axis),
                        Thickness = 0,
                        Transparency = 0,
                        Color =  LOVE_LOVIN1111.Theme.Hitbox,
                        Visible = true,
                ...
                function  LOVE_LOVIN1111111111111111111111111111111111111111111111111111111111111111111:Slider(Options)
                    ...
                    Options.Flag = Options.Flag or Options.Name
                    LOVE_LOVIN1111.Flags[Options.Flag] =  Options.Default
                    ...
                    function  LOVE_LOVIN111111111111111111111111111111111111111111111111111111111111111111111111111111111:Set(GetValue, ConvertToMin)
                        if GetValue > LOVE_LOVIN111111111111111111111111111111111111111111111111111111111111111111111111111111111.Max then 
                            return 
                        end

                        if GetValue < LOVE_LOVIN111111111111111111111111111111111111111111111111111111111111111111111111111111111.Min then 
                            return 
                        end
                        ...
                        local  LOVE_LOVIN1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111 = math.clamp(math.round(GetValue *  LOVE_LOVIN1111111111) /  LOVE_LOVIN1111111111,  Options.Min,  Options.Max)
                        local  LOVE_LOVIN11111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111 = 1 - (( Options.Max -  LOVE_LOVIN1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111) / ( Options.Max -  Options.Min))
                        ...
                        LOVE_LOVIN111111111111111111111111111111111111111111111111111111111111111111111111111111111Value.Text = ("%s%s/%s%s"):format( LOVE_LOVIN1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111,  Options.Symbol,  Options.Max,  Options.Symbol)
                        ...
                        LOVE_LOVIN111111111111111111111111111111111111111111111111111111111111111111111111111111111.Callback(GetValue)
                    end
                    ...
                    function  LOVE_LOVIN111111111111111111111111111111111111111111111111111111111111111111111111111111111:SetMax(NewMax)
                        ...
                        LOVE_LOVIN111111111111111111111111111111111111111111111111111111111111111111111111111111111.Callback( LOVE_LOVIN111111111111111111111111111111111111111111111111111111111111111111111111111111111.Current)
                    end
                    ...
                    function  LOVE_LOVIN111111111111111111111111111111111111111111111111111111111111111111111111111111111:Refresh()
                        ...
                        LOVE_LOVIN111111111111111111111111111111111111111111111111111111111111111111111111111111111:Set(LOVE_LOVIN111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111)
                    end
                ...
                function  LOVE_LOVIN1111111111111111111111111111111111111111111111111111111111111111111:Dropdown(Options)
        ...
        function  LOVE_LOVIN111111111111111111111.Watermark(Title)
